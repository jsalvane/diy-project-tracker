...
export function QuarterForm({ quarter, onChange, onSave, onCancel }: QuarterFormProps) {
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm text-gray-400 dark:text-zinc-500 pointer-events-none">$</span>
              <input
                type="number"
                step="0.01"
                ...
                className="w-full text-sm pl-6 pr-3 py-2 rounded-lg border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent tabular-nums"
              />
            </div>
          </div>
          <div>
          ...
          <div className="sm:col-span-2 lg:col-span-3">
            ...
            <input
              ...
              className="w-full text-sm px-3 py-2 rounded-lg border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
            />
          </div>
        </div>
      </div>
      ...
      {/* Notes */}
      <div className="border border-gray-200 dark:border-zinc-800 rounded-xl p-5">
        <label className="block text-xs font-semibold text-gray-500 dark:text-zinc-500 uppercase tracking-widest mb-3">
          Notes
        </label>
        <textarea
          value={quarter.notes}
      ...
      <div className="flex justify-end gap-3 pt-1">
        ...
        <button
          onClick={onSave}
          className="px-5 py-2 text-sm font-medium bg-black dark:bg-white text-white dark:text-black rounded-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
        >
          Save Changes
        </button>
      </div>
