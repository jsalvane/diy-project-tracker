...
export function ProjectCard({ project, entries, onEdit, onDelete }: Props) {
  ...
  return (
    <div
      ...
      className="border border-gray-200 dark:border-zinc-800 rounded-xl p-5 bg-white dark:bg-zinc-900 hover:border-orange-300 dark:hover:border-orange-800/60 transition-colors cursor-pointer"
    >
