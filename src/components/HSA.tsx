  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 gap-4">
      <div
        ...
        style={{ background: 'rgba(227,25,55,0.1)' }}
      >
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="rgba(227,25,55,0.8)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
